...
void main() {
  group('randomInt() method', () {
    test('positive numbers', () {
      ...
      final results = <int>[
        for (var i = 0; i < 500; i++) randomInt(min: min, max: max)
      ];
    ...
    test('zero range', () {
      ...
      final results = <int>[
        for (var i = 0; i < 500; i++) randomInt(min: value, max: value),
      ];
  ...
  group('randomDouble() method', () {
    test('positive numbers', () {
      final results = <double>[
        for (var i = 0; i < 500; i++) randomDouble(min: 0.0, max: 5.0)
      ];
    ...
    test('negative numbers', () {
      ...
      final results = <double>[
        for (var i = 0; i < 500; i++) randomDouble(min: min, max: max)
      ];
    ...
    test('zero range', () {
      ...
      final results = <double>[
        for (var i = 0; i < 500; i++) randomDouble(min: value, max: value)
      ];
